...
- **Sources/App/Environment/SessionRepositoryEnvironment.swift**
- **Sources/App/Environment/TrackRepositoryEnvironment.swift**
- **Sources/App/Environment/InsightRepositoryEnvironment.swift**
...
- **Sources/App/PreviewSupport/PreviewSessionRepository.swift**
  - 最小のサンプルセッションを返せるようにし、UI確認の価値を上げた。
- **Sources/App/PreviewSupport/PreviewTrackRepository.swift**
  - `getOrCreate` は「両方nil/空のみ throw」を守り、プレビューでも契約違反にならないようにした。
- **Sources/App/PreviewSupport/PreviewInsightRepository.swift**
...
| EnvironmentKey を App 層に定義してルートに注入 | `Sources/App/Environment/*RepositoryEnvironment.swift` + `.environment(...)` | ✅ |
